...
export const MenuOptionAndGamingContainer = styled.div`
  display: flex;
  height: 89vh;
`

export const NavBarAndGamingVideosContainer = styled.div`
  width: 80%;
  overflow-y: auto;
`

export const GameIconAndTrendingHeadingContainer = styled.div`
  display: flex;
  align-items: center;
...
`
export const GamingVideosContianer = styled.div`
  padding: 20px 20px 20px 20px;
  max-height: 100%;
`
export const EachGamingVideoUlContainer = styled.ul`
